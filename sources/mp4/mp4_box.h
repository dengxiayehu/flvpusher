...
#define MKTAG4(a, b, c, d) ((((uint8_t)(a)) << 24) | (((uint8_t)(b)) << 16) | (((uint8_t)(c)) << 8) | ((uint8_t)(d)))
...
public:
    FullBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    virtual ~FullBox() {
    }
    virtual int init(File* f);
    virtual void print() const;
...
public:
    MovieHeaderBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    TrackHeaderBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    MediaHeaderBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    VideoMediaHeaderBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    SoundMediaHeaderBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    DataReferenceBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    DataEntryUrlBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    DataEntryUrnBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    SampleDescriptionBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    TimeToSampleBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    CompositionOffsetBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    SyncSampleBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    SampleToChunkBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    SampleSizeBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    ChunkOffsetBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    ChunkLargeOffsetBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
...
public:
    esdsBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
...
public:
    EditListBox(uint32_t _sz, uint32_t _typ, uint8_t _ver, const uint24_t& _flgs);
    int init(File* f);
    virtual ~EditListBox();
