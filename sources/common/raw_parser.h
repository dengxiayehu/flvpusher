...
public:
    ...
    uint32_t get_nalu_num() const {
        return m_nalus.size();
    }
    const byte* get_nalu_data(uint32_t idx) const;
    uint32_t get_nalu_length(uint32_t idx) const;

    const byte* get_sps() const {
        return m_sps;
    }
    uint32_t get_sps_length() const {
        return m_sps_len;
    }
    const byte* get_pps() const {
        return m_pps;
    }
    uint32_t get_pps_length() const {
        return m_pps_len;
    }
    ...
    bool sps_pps_changed() {
        return m_sps_pps_changed;
    }
...
public:
    ...
    const byte* get_asc() const {
        return m_asc;
    }

private:
    static void adts_header2asc(const byte adts_header[7], byte asc[2]);
