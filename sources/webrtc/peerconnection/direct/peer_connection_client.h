#ifndef PEERCONNECTION_SAMPLES_DIRECT_PEER_CONNECTION_CLIENT_H_
#define PEERCONNECTION_SAMPLES_DIRECT_PEER_CONNECTION_CLIENT_H_
#pragma once
...
struct PeerConnectionClientObserver {
  virtual void OnSignedIn() = 0;  // Called when we are logged on.
  virtual void OnDisconnected() = 0;
  virtual void OnPeerConnected(int id, const std::string &name) = 0;
  virtual void OnPeerDisconnected(int peer_id) = 0;
  virtual void OnMessageFromPeer(int peer_id, const std::string &message_) = 0;
...
#endif // PEERCONNECTION_SAMPLES_DIRECT_PEER_CONNECTION_CLIENT_H_
