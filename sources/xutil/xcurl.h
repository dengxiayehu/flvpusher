...
public:
    ...
    struct request {
        ...
        static request* build(request_type type, const char* url,
                              ...
                              bool no_signal = true, bool follow_location = true, long max_redirs = -1,
                              bool progress = false, size_t (*read_cb)(void*, size_t, size_t, void*) = NULL,
                              void* read_data = NULL, const char* post_fields = NULL, long post_field_size = -1,
                              char* cookie_file = NULL, long low_speed_limit = -1, long low_speed_time = -1,
