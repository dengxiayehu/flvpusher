...
public:
    ...
    char const* str_value() const {
        return m_str_value;
    }
    char const* str_value_to_lower() const {
        return m_str_value_to_lower;
    }
    int int_value() const {
        return m_int_value;
    }
    bool value_is_hexadecimal() const {
        return m_value_is_hexadecimal;
    }
...
public:
    ...
    MediaSession& parent_session() {
        return m_parent;
    }
    MediaSession const& parent_session() const {
        return m_parent;
    }

    const char* control_path() const {
        return m_control_path;
    }
    const char* protocol_name() const {
        return m_protocol_name;
    }

    char*& _abs_start_time() {
    ...
    unsigned short client_port_num() const {
        return m_client_port_num;
    }
    unsigned char rtp_payload_format() const {
        return m_rtp_payload_format;
    }
    bool rtcp_is_muxed() const {
        return m_multiplex_rtcp_with_rtp;
    }
    ...
    char*& connection_endpoint_name() {
        return m_conn_endpoint_name;
    }
